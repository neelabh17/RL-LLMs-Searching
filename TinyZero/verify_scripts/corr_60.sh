...
DATA_DIR=/gpfs/data/ranganathlab/Jatin/verl_neel/data/neelabh17/star-graph-deg-5-path-5-nodes-300_out_of_the_box_num_gen_10_Qwen2.5-14B-Instruct_1_corr_60
ROLLOUT_TP_SIZE=1
...
EXPERIMENT_NAME=1.5B_partial_corr_60
N_GPUS=1 # use 4xA100

CUDA_VISIBLE_DEVICES=1 python3 -m verify \
...
actor_rollout_ref.rollout.val_kwargs.n=100 \
