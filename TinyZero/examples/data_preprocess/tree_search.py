...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='anirudhb11/star-graph-deg-3-path-5-nodes-300')

    args = parser.parse_args()

    data_source = 'tree_search'
...
'''
Run as
python examples/data_preprocess/tree_search.py --local_dir /gpfs/data/ranganathlab/Jatin/verl_neel/data --template_type qwen-instruct --dataset_name anirudhb11/star-graph-deg-10-path-10-nodes-300 
'''
