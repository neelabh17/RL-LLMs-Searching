...
dataset_name_template = "neelabh17/{type}_out_of_the_box_num_gen_100_Qwen2.5-{size}B-Instruct"

for type_name in tqdm(types):
    for size in tqdm(sizes):
        dataset_name = dataset_name_template.format(type=type_name, size=size)
        print(dataset_name)
        # load HF dataset
