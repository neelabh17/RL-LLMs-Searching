...
python helpers/infer_out_of_the_box.py \
--dataset_name "anirudhb11/star-graph-deg-10-path-10-nodes-300" \
...
if __name__ == "__main__":
    ...
    dataset = load_dataset(final_ds, split="test") # use the train split only
    dataset = dataset.select(range(0, 100)) # select first 100 samples for testing
